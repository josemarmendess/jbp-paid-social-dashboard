...
export function aggregateByAd(
  ...
  for (const r of meta) {
    ...
    if (!agg) {
      ...
      // Adset wins over ST attribution — see resolveAdService docs.
      const businessUnit = resolveAdService(
        key,
        r.adset_name,
        r.campaign_name,
        audience,
 ...
 * BusinessUnit filter. Single source of truth for the resolution chain
 * lives in resolveAdService.
 */
