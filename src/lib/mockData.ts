...
// ─── Chicago-area zip codes (must exist in chicago_zip_centroids.json) ───────
const ZIPS = [
  ...
  60656, 60657, 60659, 60660, 60661, 60706, 60707, 60712, 60714,
  60201, 60202, 60203, 60301, 60302, 60304, 60305,
  60402, 60406, 60411, 60415, 60419, 60422, 60425, 60426, 60428,
  60439, 60440, 60441, 60443, 60445, 60448, 60452, 60453, 60455,
  60462, 60463, 60464, 60465, 60467, 60477, 60490, 60491,
  60502, 60503, 60504, 60505, 60506, 60515, 60516, 60517,
  60525, 60526, 60527, 60540, 60563, 60564, 60565, 60585, 60586,
];
